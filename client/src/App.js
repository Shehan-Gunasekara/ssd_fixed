  ...
  return (
    <BrowserRouter basename={process.env.PUBLIC_URL}>
      ...
      <Routes>
        ...
        <Route
          path="/orderedProductsReport"
          element={<OrderedProductsReport />}
        />
        ...
        <Route
          path="/SupplierPaymentForm/:orderID/:supplierID"
          element={<SupplierPaymentForm />}
        />
        <Route
          path="/ViewSupplierPayment/:orderID/:supplierID/:historyID/:Tdate/:file"
          element={<ViewSupplierPayment />}
        />
        <Route path="/FinancialOverview" element={<FinancialOverview />} />
        <Route
          path="/SupplierPayementReportPage"
          element={<SupplierPayementReportPage />}
        />

        <Route
          path="/inventory-homepage"
          element={
            localStorage.getItem("employee") ? (
              <InventoryHomePage />
            ) : (
        ...
        />
        <Route
          path="/inventory-add-product-page"
          element={
            localStorage.getItem("employee") ? (
              <InventoryAddNewProductPage />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        />
        <Route
          path="/inventory-product-overview-page/:id"
          element={
            localStorage.getItem("employee") ? (
              <InventoryProductOverviewPage />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        />
        <Route
          path="/inventory-product-update-page/:id"
          element={
            localStorage.getItem("employee") ? (
              <InventoryUpdateProductPage />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        />
        <Route
          path="/inventory-raw-materials-page"
          element={
            localStorage.getItem("employee") ? (
              <InventoryRawMaterialsPage />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        />
        <Route
          path="/inventory-add-raw-material-page"
          element={
            localStorage.getItem("employee") ? (
              <InventoryAddRawMaterialPage />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        />
        <Route
          path="/inventory-raw-material-overview-page/:id"
          element={
            localStorage.getItem("employee") ? (
              <InventoryRawMaterialOverview />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        />
        <Route
          path="/inventory-new-order-page"
          element={
            localStorage.getItem("employee") ? (
              <InventoryNewOrderPage />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        />
        <Route
          path="/inventory-cart-overview-page"
          element={
            localStorage.getItem("employee") ? (
              <InventoryCartOverviewPage />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        />
        <Route
          path="/inventory-pending-orders-page"
          element={
            localStorage.getItem("employee") ? (
              <InventoryPendingOrdersPage />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        ...
        />
        <Route
          path="/inventory-past-orders-page"
          element={
            localStorage.getItem("employee") ? (
              <InventoryPastOrdersPage />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        ...
        <Route
          ...
          element={<CustomerProductOverviewPage />}
        />
        ...
        />
        <Route
          path="/update-supplier-details/:id"
          element={
            localStorage.getItem("employee") ? (
              <SupplierDetails />
            ) : (
        ...
        />
        <Route
          path="/supplier-reports/:name/:rawMaterial"
          element={
            localStorage.getItem("employee") ? (
        ...
        />
        <Route
          path="/supplier-reports/:rawMaterial"
          element={
            localStorage.getItem("employee") ? (
              <SupplierRawMaterialReport />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        />
        <Route
          path="/supplier-payment-info/:name/:rawMaterial"
          element={
            localStorage.getItem("employee") ? (
              <PaymentInfo />
            ) : (
        ...
        />
        <Route
          path="/supplier-status-reports/:status"
          element={
            localStorage.getItem("employee") ? (
              <SupplierStatus />
            ) : (
        ...
        <Route
          ...
          element={
            localStorage.getItem("employee") ? (
              <DeliveringOrdersDeliverymanager />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        ...
        <Route
          ...
          element={
            localStorage.getItem("employee") ? (
              <CompletedOrdersDeliverymanager />
            ) : (
              <Navigate to="/not-authorized" />
            )
          }
        ...
        <Route
          ...
          element={
            !localStorage.getItem("employee") ? (
              ...
              <Navigate to="/emp-account-redirect" />
            )
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            localStorage.getItem("employee") ? (
              ...
              <Navigate to="/emp-login-redirect" />
            )
          }
        />
