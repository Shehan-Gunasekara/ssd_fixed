  ...
  useEffect(() => {
    const fetchOrder = async () => {
      ...
      if (response.ok) {
        ...
        axios
          .get(`/api/v7/orderedProduct/getProductbyOrderid/${id}`)
          .then((getData) => {
    ...
    if (name == Number(name)) {
      setValidation(
        <p role="alert" style={{ fontSize: "13px", marginTop: -20 }}>
          <font color="red">
            <strong>Please enter a text for the Name</strong>
          </font>
        </p>
      );
      status = false;
    ...
    if (deliveryFeedback.length == 0) {
      setValidationdesc(
        <p role="alert" style={{ fontSize: "13px", marginTop: -25 }}>
          <font color="red">
            <strong>Please enter a text</strong>
          </font>
        </p>
      );
      status = false;
    ...
    <div class="liton__wishlist-area pb-70">
      ...
      <Modal show={showModal} onHide={handleClose} keyboard={false}>
        <Modal.Header closeButton>
          <Modal.Title style={{ marginTop: 20, marginLeft: 20 }}>
            Delete Feedback
          </Modal.Title>
        </Modal.Header>
                        ...
                        <div class="ltn__myaccount-tab-content-inner">
                          <div class="row">
                            <div class="col-md-6 col-12 learts-mb-30">
                              ...
                              <h4>
                                Customer ID <small>{CustomerID}</small>
                              </h4>
                              <h4>
                            ...
                            <section className="section">
                              <div className="row">
                                <div style={{ display: notice }}>
                                  <h5>
                                    You need to receive your order to add
                                    feedback
                                  </h5>
                                </div>
                                ...
                                <div
                                  className="card"
                                  style={{ display: divfeedback }}
                                >
                                  <div className="card-body">
                                    <h5 className="card-title">
                                      {updateOrInsert} your feedback
                                    </h5>
