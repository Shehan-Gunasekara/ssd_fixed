...
function Trackbodysample(props) {
  ...
  const handlestatus = async (e) => {
    ...
    if (response.ok) {
      ...
      if (!window.confirm("Congrats! You recived the order")) {
        // navigate("/");
      }
    }
  };
  ...
  const handleFeedbackdelete = async (e) => {
    ...
    if (window.confirm("Do you want to delete this delivery Feedback?")) {
      ...
      if (response.ok) {
        ...
        if (!window.confirm("Feedback deleted successfully")) {
          // navigate("/");
        }
      }
    }
      ...
      <section class="section">
        <div class="card-body , card">
          ...
          <button
            ...
            type="button"
            class="btn btn-link"
            onClick={handleDeletedeliveryrecode}
          >
          ...
          <div class="progress" style={{ height: "25px" }}>
            <div
              ...
              aria-valuemax="100"
            >
              {deliveryFeadback["deliveryStatus"]}
            </div>
          </div>
                ...
                <div className="col-lg-12">
                  <div className="card" style={{ marginTop: 30 }}>
                    <div className="card-body">
                      ...
                      <form
                        className="row g-3"
                        onSubmit={props.buttonName === "submit" ? "" : ""}
                      >
